 ...
 *
 * <p>
 * subjectNumber (health ID) is intentionally NOT included — Odoo and OpenMRS
 * own and supply that value; OpenELIS never originates it.
 */
public record NidanPatientSyncNotification(String guid, String firstName, String lastName, String gender,
        String birthDateForDisplay, String nationalId, String changeType) {
}
