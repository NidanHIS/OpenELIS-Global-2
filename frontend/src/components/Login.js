  ...
  const loginMessage = () => {
    ...
    return (
      <>
        ...
        <Column lg={4} md={8} sm={4} className="oe-loginBrandingColumn">
          <picture className="oe-loginBrandingLogoWrap">
            <img
              className="oe-loginBrandingLogo"
              src={logoSrc}
              alt="fullsize logo"
              width="300"
              height="56"
    ...
    <>
      ...
      >
        ...
        <div className="oe-loginPageCenter">
          <div className="oe-loginShell">
            <div className="oe-loginHero">
              <Grid fullWidth={true}>{loginMessage()}</Grid>
            </div>
            <div className="oe-loginFormRow">
              <Grid fullWidth={true} className="oe-loginFormGrid">
                <Column lg={6} md={2} sm={0} />
                <Column lg={4} md={4} sm={4}>
                  <Section className="oe-loginFormSection">
                    {samlRedirectInitiated ? (
                      <Stack gap={5}>
                        <FormLabel>
                          <Heading>
                      ...
                      >
                        {({ isValid, handleChange, handleSubmit }) => (
                          <Form onSubmit={handleSubmit} onChange={handleChange}>
                            <Stack gap={5} className="oe-loginFormStack">
                              <FormLabel>
                                <Heading>
                                  <FormattedMessage id="login.title" />
                                </Heading>
                              </FormLabel>
                              {configurationProperties?.useFormLogin ==
                                "true" && (
                                <>
                                  <TextInput
                                    className="oe-loginField"
                                    id="loginName"
                                  ...
                                  <Stack
                                    ...
                                    className="oe-loginButtonRow"
                                  >
                                    <Button
                                      type="submit"
                                      disabled={!isValid}
                                      data-cy="loginButton"
                                      className="oe-loginPrimaryButton"
                                    >
                                    ...
                                    <Button
                                      ...
                                      type="button"
                                      className="oe-loginSecondaryButton"
                                      onClick={() => {
